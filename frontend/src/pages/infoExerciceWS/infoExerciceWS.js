...
const InfoExerciceWS = () => {
    ...
    return (
        <div>
            ...
            <div>
                <img src="brain.png" className='brainImg' style={{ width: '400px', height: '400px' }}></img>
            </div>
        </div >
    );
};

export default InfoExerciceWS;
