...
const MaisonDesNombres = ({ onMdnData }) => {
    ...
    function showRedux() {
        ...
        //axios.post('http://backendContainer:4000/exercice/post_mdn_exercices', exerciceRedux)
    }
    ...
    function valideReponses() {
        ...
        axios.get('http://backendContainer:4000/exercice/get_mdn_exercice').then((res) => {
            ...
            axios.post("http://backendContainer:4000/exercice/registerAnswers", { data }, config)
        })
