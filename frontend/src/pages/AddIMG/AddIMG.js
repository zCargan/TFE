...
const AddIMG = () => {
    ...
    function valideImg() {
        ...
        const sendImage = async () => {
          try {
            const response = await axios.post('https://www.laclassedemadameseverine.be:4000/photos', formData, {
              headers: {
    ...
    function valideArray() {
        ...
        axios.post('https://www.laclassedemadameseverine.be:4000/photos', formData)
    }
    ...
    function getImg() {
      axios.get('https://www.laclassedemadameseverine.be:4000/photos/getImg')
          .then(res => {
