    ...
    useEffect(() => {
        const fetchExos = async () => {
            try {
                ...
                const response = await axios.post("https://www.laclassedemadameseverine.be:4000/connection/infoUser", {}, config);
                const data = { id: response.data.id };

                const exosResponse = await axios.post("https://www.laclassedemadameseverine.be:4000/exercice/getExosFromUser", { data });
