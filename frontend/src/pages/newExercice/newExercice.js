                ...
                <div id="newExercice">
                    ...
                    <div className="divExoCreation" id="div_img_create_exercice">
                        ...
                        >
                            <div className='popupExos'>
                                <h3>Mot bazar</h3>
                                <p>Recomposer un mot possédant les lettres mélangées et ce, par rapport à une photo</p>
                            </div>
                        </Popup>
                        <Popup
                            trigger={
                        ...
                        >
                            <div className='popupExos'>
                                ...
                                <p>
                                    Vous pouvez créer ici un exercice utilisant le son. Vous pouvez <a href="https://www.laclassedemadameseverine.be/uploadSound" id="soundLink">
                        ...
                        >
                            <div className='popupExos'>
                                ...
                                <p>
                                    Réaliser un exercice dans lequel l'utilisateur doit retrouver le mot correspondant à chaque image proposée.
                                </p>
                            </div>
                        </Popup>
                        <Popup
                    ...
                    <div className="divExoCreation" id="div_photo_create_exercice">
                        ...
                        >
                            <div className='explicationExo'>
                                <p>Endroit où vous pouvez ajouter des <span className='divSpanButton'>images</span> à votre profil.</p>
                                <br />
                                <p>Si vous désirez créer des <span className='divSpanButton'>"Texte avec images"</span> ou des <span className='divSpanButton'>"Mot bazar"</span>, pensez à ajouter des images à votre compte.</p>
                            </div>
                        </Popup>
                        <h2>Partie photo : </h2>
                    ...
                    <div className="divExoCreation" id="div_son_create_exercice">
                        ...
                        >
                            <div className='explicationExo'>
                                ...
                                <br />
                                <p>Si vous désirez créer des <span className='divSpanButton'>"Sons avec texte"</span>, pensez à ajouter des sons à votre compte.</p>
                            </div>
                        </Popup>
                        <h2>Partie son : </h2>
