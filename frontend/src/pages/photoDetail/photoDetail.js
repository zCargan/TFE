...
const PhotoDetail = () => {
    ...
    useEffect(() => {
        axios.get(`https://www.laclassedemadameseverine.be:4000/photos/getDetail/${idPhoto}`)
            .then((res) => {
                setId(res.data[0].id);
    ...
    function renameImg() {
        ...
        axios.post(`https://www.laclassedemadameseverine.be:4000/photos/changeName/${id}`, data, config).then((res) => {
            console.log(res)
        })
            .catch((error) => {
                console.log(error)
    ...
    function deleteImg() {
        ...
        axios.delete(`https://www.laclassedemadameseverine.be:4000/photos/deleteImage/${id}`, {}, config).then((res) => {
            Swal.fire({
                icon: "success",
