...
const ShowWorksheetById = () => {
    ...
    function testPQ2() {
        ...
        axios.get("http://backendContainer:4000/exercice/getWorksheet", config)
            .then(res => {
    ...
    function testPQ3() {
        console.log("on passe dans testPQ2")
        axios.get(`http://backendContainer:4000/exercice/getWS/${exo}`, config)
            .then(res => {
    ...
    function getWSById() {
        ...
        axios
            .get(`http://backendContainer:4000/exercice/getWS/${exo}`)
            .then((res) =>
                console.log(res.data)
            )
