...
const UpdateSounds = ({ onSoundSelect }) => {
    ...
    function getSon() {
        ...
        axios.post("https://www.laclassedemadameseverine.be:4000/connection/infoUser", {}, config)
            .then(response => {
                let id = response.data.id
                axios.get(`https://www.laclassedemadameseverine.be:4000/sound/getSound/${id}`, {}, config)
                    .then((res) => {
